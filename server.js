...
// ─── Conector MCP — expõe as ferramentas do Bling em /sse para o Claude ──
const { registrarRotasMcp } = require('./src/services/bling-mcp');
registrarRotasMcp(app, { blingRequest, montarPayloadProdutoBling, listarBlingCategorias, idCategoriaPai: _idCategoriaPai });
